...
from ..forms import ItemForm, EMPTY_LIST_ERROR, DUPLICATE_ITEM_ERROR, ExistingListItemForm, NewListForm
...
class ExistingListItemFormTest(TestCase):
    ...
    def test_form_validation_for_blank_items(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertEquals(form.errors['text'], [EMPTY_LIST_ERROR])
    ...
    def test_form_validation_for_duplicate_items(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertEquals(form.errors['text'], [DUPLICATE_ITEM_ERROR])
...
class NewListFormTest(unittest.TestCase):
    ...
    def test_save_creates_new_list_and_item_from_post_data(self, mockItem, mockList):
        ...
        def check_item_text_and_list():
            self.assertEquals(mock_item.text, 'new item text')
            self.assertEquals(mock_item.list, mock_list)
    ...
    def test_save_returns_new_list_object(self, mock_List_create_new):
        ...
        self.assertEquals(response, mock_List_create_new.return_value)
